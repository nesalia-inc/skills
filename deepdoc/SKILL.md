---
name: deepdoc
description: Analyzes package documentation for completeness, find missing content, and assess quality. Use when asked to review, audit, or find gaps in library/SDK documentation, or when users say "review my doc", "analyze this package", "find missing content". Example: "/deepdoc docs/" or "@deepdoc analyze docs/"
...
| 18 | **fresh fetch on critical external links** (verify 404 / deprecated) | Links to RFCs, cloud docs, external refs | Dead links destroy trust |
